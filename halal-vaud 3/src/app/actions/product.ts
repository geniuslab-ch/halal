...
export async function addExistingProductToShop(formData: FormData) {
  ...
  await prisma.shopProduct.upsert({
    ...
    update: { price, stockStatus: stockStatus as never, lastPriceUpdate: new Date(), lastAvailabilityUpdate: new Date() },
    create: { shopId, productId, price, stockStatus: stockStatus as never },
  });
